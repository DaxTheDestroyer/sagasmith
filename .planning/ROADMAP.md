...
- [x] **Phase 7: Memory, Vault, and Resume Differentiator** - User gets durable spoiler-safe campaign memory, repairable vaults, recap, and later-process resume. (completed 2026-04-29)
- [x] **Phase 8: Retcon, Repair, and Release Hardening** - User can safely retcon the last turn and the release gate proves the MVP smoke flow. (completed 2026-04-29)
...
- [x] 07-04-PLAN.md — Additional skills: visibility-promotion, rolling-summary-update, session-page-authoring, canon-conflict stub (VAULT-03, VAULT-05, VAULT-08, AI-11)
- [x] 07-05-PLAN.md — Player-vault sync, CLI repair commands, /recap, quit/resume integration (CLI-04, VAULT-03, VAULT-04, VAULT-05, VAULT-09, VAULT-10, TUI-08, PERS-05)
...
- [x] 08-03-PLAN.md — Replace the `/retcon` stub with recent-turn picker, impact preview, exact typed confirmation token, completion messaging, and blocked-repair guidance (QA-01, QA-02).
...
| 8. Retcon, Repair, and Release Hardening | 4/4 | Complete | 2026-04-29 |
