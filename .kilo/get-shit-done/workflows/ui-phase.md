...
```markdown
Read C:/PersonalDevFiles/KiloCodeFiles/AI-TTRPG-GoAnywhereDoAnything/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/PersonalDevFiles/KiloCodeFiles/AI-TTRPG-GoAnywhereDoAnything/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/PersonalDevFiles/KiloCodeFiles/AI-TTRPG-GoAnywhereDoAnything/.kilo/agents/gsd-ui-checker.md for instructions.
